...
if __name__ == "__main__":
    ...
    res = genData.runSimMT(fitMethod="nelder-mead", nEpochs=1, rrs=tensor([[20, 20, 20], [25, 25, 25]]), pis=tensor([[.005, .005, .005], [.01, .01, .01]]),
                     nCases=tensor([10e3, 10e3, 4e3]), nCtrls=tensor(3e5), afMean = 1e-6, nIterations=100)

    np.save("simulation-res-rr20,25-5-24-20", res)
