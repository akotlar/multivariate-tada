...
model_sklearn = GaussianMixture(2)
model_sklearn.fit(X)
means = model_sklearn.means_
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
print(model_sklearn.weights_)
print(model_sklearn.means_)
print(csim(model_sklearn.means_[0],Lambda[1]))
print(csim(model_sklearn.means_[0],Lambda[0]))
print(csim(model_sklearn.means_[1],Lambda[0]))
print(csim(model_sklearn.means_[1],Lambda[1]))
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
...
print(model.pi)
print('M',np.mean(model.Lambda,axis=1))
print('T',np.mean(Lambda,axis=1))
