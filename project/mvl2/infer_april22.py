...
def get_rho_bivariate(probs, weights, concentrations, observations: ArrayLike, n_samples: int | ArrayLike, prevalences = None, hypothesis_order = None, true_architectures: np.ndarray = None):
    """
    ...
    if jnp.isscalar(n_samples) or n_samples.shape == ():
    ...
    alleles = n_samples * 2 # type: ignore
